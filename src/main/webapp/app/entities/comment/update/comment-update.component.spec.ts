...
describe('Comment Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Comment query and add missing value', () => {
      ...
      const child: IComment = { id: 8540 };
      comment.child = child;

      const commentCollection: IComment[] = [{ id: 8569 }];
    ...
    it('Should call User query and add missing value', () => {
      const comment: IComment = { id: 456 };
      const login: IUser = { id: '3f99ea3f-fc86-418d-b7a3-457bbe5cc992' };
      comment.login = login;

      const userCollection: IUser[] = [{ id: 'bc3dfe1f-55bb-4702-8fc4-8b338a4e427f' }];
    ...
    it('Should update editForm', () => {
      const comment: IComment = { id: 456 };
      const child: IComment = { id: 31313 };
      comment.child = child;
      const login: IUser = { id: 'd86d1131-1216-433b-8f17-d4cccf897a3d' };
      comment.login = login;
