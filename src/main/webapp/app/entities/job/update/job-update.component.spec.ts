...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 18699 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 24282 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 26849 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 6859 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 14185 };
      job.tasks = [task];
      const employee: IEmployee = { id: 22875 };
      job.employee = employee;
