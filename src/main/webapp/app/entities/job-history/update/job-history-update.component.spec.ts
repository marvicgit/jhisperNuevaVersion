...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 16318 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 14262 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 19036 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 14604 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 7391 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 27261 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 13774 };
      jobHistory.job = job;
      const department: IDepartment = { id: 22621 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 18608 };
      jobHistory.employee = employee;
