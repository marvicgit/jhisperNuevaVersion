...
import munlima.gob.pe.domain.JobHistory;
import munlima.gob.pe.repository.JobHistoryRepository;
import munlima.gob.pe.service.JobHistoryService;
...
/**
 * REST controller for managing {@link munlima.gob.pe.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
