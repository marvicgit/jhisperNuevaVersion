...
/**
 * REST controller for managing {@link munlima.gob.pe.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CommentResource {
    ...
    public List<Comment> searchComments(@RequestParam String query) {
        ...
        try {
            return StreamSupport.stream(commentSearchRepository.search(query).spliterator(), false).toList();
