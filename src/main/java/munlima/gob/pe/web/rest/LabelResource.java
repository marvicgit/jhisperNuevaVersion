...
import munlima.gob.pe.domain.Label;
import munlima.gob.pe.repository.LabelRepository;
import munlima.gob.pe.repository.search.LabelSearchRepository;
...
/**
 * REST controller for managing {@link munlima.gob.pe.domain.Label}.
 */
@RestController
@RequestMapping("/api")
@Transactional
