...
import munlima.gob.pe.repository.search.AttachmentSearchRepository;
import munlima.gob.pe.web.rest.errors.BadRequestAlertException;
import munlima.gob.pe.web.rest.errors.ElasticsearchExceptionMapper;
...
/**
 * REST controller for managing {@link munlima.gob.pe.domain.Attachment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AttachmentResource {
    ...
    public ResponseEntity<Attachment> createAttachment(@Valid @RequestBody Attachment attachment) throws URISyntaxException {
        ...
        attachmentSearchRepository.index(result);
    ...
    public List<Attachment> searchAttachments(@RequestParam String query) {
        ...
        try {
            return StreamSupport.stream(attachmentSearchRepository.search(query).spliterator(), false).toList();
