...
import munlima.gob.pe.domain.Project;
import munlima.gob.pe.repository.ProjectRepository;
import munlima.gob.pe.repository.search.ProjectSearchRepository;
...
/**
 * REST controller for managing {@link munlima.gob.pe.domain.Project}.
 */
@RestController
@RequestMapping("/api")
@Transactional
