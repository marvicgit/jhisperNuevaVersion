...
import munlima.gob.pe.domain.Employee;
import munlima.gob.pe.repository.EmployeeRepository;
import munlima.gob.pe.repository.search.EmployeeSearchRepository;
...
/**
 * REST controller for managing {@link munlima.gob.pe.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
