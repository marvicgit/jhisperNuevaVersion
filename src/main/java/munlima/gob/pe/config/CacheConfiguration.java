...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, munlima.gob.pe.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, munlima.gob.pe.repository.UserRepository.USERS_BY_EMAIL_CACHE);
