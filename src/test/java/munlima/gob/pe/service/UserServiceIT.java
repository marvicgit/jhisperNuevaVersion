...
import munlima.gob.pe.config.Constants;
...
import munlima.gob.pe.security.AuthoritiesConstants;
import munlima.gob.pe.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the munlima.gob.pe.repository.search test package.
     *
     * @see munlima.gob.pe.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
